...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Otakugram").description("Projeto API Spring - Otakugram")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/talisilva")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Talissa Agatha", "https://github.com/talisilva", "talissaagtha@gmail.com");
	}
